...
# Use English bird species names if translation enabled, otherwise Finnish
if os.environ.get('ENABLE_TRANSLATION', '0') == '1':
    birds_file = './inputs/bird-metadata-refined/bird_species_english.csv'
else:
    birds_file = './inputs/bird-metadata-refined/bird_species_finnish.csv'
...
if STATS_MODE == 'random_effects':
    ...
    heatmap_title = 'Effect of bird species on theme (|log-odds|)'
    barplot_title = 'Strongest bird species-theme associations (p ≤ 0.01)'
    heatmap_vmax = 1.5
    ...
    # Configuration for plots
    heatmap_title = "Effect of bird species on theme (Cramér's V)"
    barplot_title = "Strongest bird species-theme associations (p ≤ 0.01)"
    heatmap_vmax = 0.4
