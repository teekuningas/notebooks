...
if STATS_MODE == 'random_effects':
    ...
    barplot_title = f'Strongest bird species-theme associations (|log-odds| ≥ {effect_threshold})'
    heatmap_vmax = 1.5
    ...
    barplot_title = f"Strongest bird species-theme associations (V ≥ {effect_threshold})"
    heatmap_vmax = 0.4
